    ...
    <section id="about" className="py-16 lg:py-24 bg-gradient-to-tr from-gr-50 to-green-400/10 px-6 sm:px-12 lg:px-20">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* Right: Image */}
          <div className="relative w-full h-80 lg:h-[420px] rounded-2xl overflow-hidden shadow-lg" data-aos="fade-left">
            <Image
        ...
        <div className="grid sm:grid-cols-2 gap-6 mt-16">
          ...
          {/* Vision */}
          <div className="bg-gradient-to-r from-[#0c448d]/5 to-[#038b8b]/5 p-6 rounded-2xl border border-[#0c448d]/10 shadow-sm hover:shadow-md transition-shadow duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-[#0c448d]/70 text-base leading-relaxed">
                  To ensure comprehensive healthcare for every life through limitless innovative solutions.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Mission */}
          <div className="bg-gradient-to-r from-[#038b8b]/5 to-[#0c448d]/5 p-6 rounded-2xl border border-[#038b8b]/10 shadow-sm hover:shadow-md transition-shadow duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="200">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-[#0c448d]/70 text-base leading-relaxed">
                  At Statheros, our mission is to stabilize health and enhance life by delivering safe, effective, and affordable medicines with uncompromising quality.
                </p>
              </div>
            </div>
          </div>
