                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
                    ...
                    <div className="space-y-5 lg:space-y-7">
                        ...
                        <p className="text-base slabo font-sans sm:text-lg text-indigo-900/60 leading-relaxed text-pretty max-w-2xl animate-fade-in">
                            A growing force in the pharmaceutical world, built on
                            trust, quality, and innovation. We craft medicines that
                            combine scientific excellence with genuine care.
                        </p>
