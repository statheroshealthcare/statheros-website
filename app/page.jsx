        ...
        return (
            <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-[#e0f2ff] to-[#f0f9ff]">
                <div className="relative flex items-center justify-center w-28 h-28">
                    {/* Spinner border */}
                    <div className="absolute w-28 h-28 rounded-full border-4 bg-[#038b8b]/5 border-[#0c448d]/10 border-t-[#038b8b] animate-spin-slow shadow-lg"></div>
                    
                    {/* Logo Image instead of "S" */}
                    <Image
                        src="/favicon.ico"
                        alt="Logo"
                        width={50}
                        height={50}
                        className="rounded-2xl shadow-md animate-pulse-fast  bg-white"
                        priority
                    />
                </div>
